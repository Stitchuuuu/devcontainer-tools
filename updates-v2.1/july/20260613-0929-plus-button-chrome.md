...
`````bash
git apply --check .tmp/devcontainer-updates/updates-v2.1/july/20260613-0929-plus-button-chrome.patch
git apply        .tmp/devcontainer-updates/updates-v2.1/july/20260613-0929-plus-button-chrome.patch
