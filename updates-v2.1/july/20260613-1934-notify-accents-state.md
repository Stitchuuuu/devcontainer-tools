...
`````bash
git apply --check .tmp/devcontainer-updates/updates-v2.1/july/20260613-1934-notify-accents-state.patch
git apply        .tmp/devcontainer-updates/updates-v2.1/july/20260613-1934-notify-accents-state.patch
