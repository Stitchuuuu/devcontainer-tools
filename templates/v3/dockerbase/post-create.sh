#!/bin/bash
# TODO(v3 launch): DELETE — superseded by hooks/post-create.d/*.sh via devc-hook dispatcher.
# Kept in-tree during v3 development to preserve git history / diff-review of the split.
# Remove when the first project consumes hooks/ instead of source-copying this file.
#
