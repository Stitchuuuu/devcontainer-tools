...
def to_openai_chat_request(
    ...
    Args:
        ...
        enable_thinking: bool - Send Ollama-style `think: true` so backends that separate
            reasoning into a dedicated SSE field (Ollama 0.9+ for qwen3 / qwen3.5 / deepseek-r1
            etc.) actually stream it instead of dropping it silently.
