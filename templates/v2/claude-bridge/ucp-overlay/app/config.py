...
class ModelConfig(BaseModel):
    ...
    Attributes:
        ...
        enable_thinking: bool - Pass `think: true` to Ollama-style backends and re-inject their `reasoning` SSE deltas as <think>...</think> markers in the text stream (use_react / _process_raw converts those to Anthropic thinking blocks). Off by default to preserve original behavior for clients that reject unsigned thinking blocks.
    """
